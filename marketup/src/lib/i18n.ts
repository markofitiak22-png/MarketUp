...
export const translations: Record<Language, Translations> = {
  ...
  de: {
    ...
    studioSelectVirtualPresenter: "Wählen Sie einen virtuellen Präsentator",
    studioEachAvatarUnique: "Jeder Avatar ist einzigartig",
    studioShort: "Kurz",
    studioMedium: "Mittel",
    studioLong: "Lang",
    ...
    onboardingStep1Title: "Konto erstellen",
    onboardingStep1Desc: "Erstellen Sie Ihr Konto und wählen Sie Ihren Plan",
    onboardingStep2Title: "Avatar auswählen",
    onboardingStep2Desc: "Wählen Sie Ihren perfekten AI-Avatar",
    onboardingStep3Title: "Erstes Video erstellen",
    onboardingStep3Desc: "Erstellen Sie Ihr erstes professionelles Video",
    ...
    pricingBasicPeriod: "/Monat",
    pricingBasicDescription: "Perfekt für kleine Unternehmen",
    ...
    pricingProDescription: "Ideal für wachsende Unternehmen",
    pricingProFeatures: [
      "20 Videos pro Monat",
      "4K-Qualität",
      "Alle Avatare",
    ...
    pricingEnterpriseDescription: "Für große Unternehmen",
    ...
    aboutSubtitle: "Wir revolutionieren die Art, wie Unternehmen Videos erstellen",
    aboutMission: "Unsere Mission",
    aboutMissionText: "Wir machen es jedem Unternehmen möglich, professionelle Videos zu erstellen, ohne teure Ausrüstung oder Fachkenntnisse zu benötigen.",
    aboutVision: "Unsere Vision",
    aboutVisionText: "Eine Welt, in der jedes Unternehmen die Kraft des Videos nutzen kann, um mit seinen Kunden zu kommunizieren.",
    aboutValues: "Unsere Werte",
    aboutValue1Title: "Einfachheit",
    aboutValue1Text: "Wir glauben, dass Technologie einfach zu verwenden sein sollte.",
    aboutValue2Title: "Qualität",
    aboutValue2Text: "Wir liefern nur die beste Qualität für unsere Kunden.",
    aboutValue3Title: "Innovation",
    aboutValue3Text: "Wir sind immer auf der Suche nach neuen Wegen, um zu helfen.",
    aboutTeam: "Unser Team",
    aboutTeamText: "Wir sind ein leidenschaftliches Team von Entwicklern, Designern und Unternehmern.",
    aboutJoinUs: "Treten Sie unserem Team bei",
    aboutJoinUsText: "Wir suchen immer nach talentierten Menschen, die uns helfen, unsere Mission zu erfüllen.",
    aboutJoinUsButton: "Jetzt bewerben",
    ...
    dashboardViewAnalytics: "Analytics ansehen",
    dashboardManageSubscription: "Abonnement verwalten",
    dashboardVideosCount: "Videos erstellt",
    dashboardStorageUsed: "Speicher verwendet",
    dashboardVideosThisMonth: "Videos diesen Monat",
    dashboardTotalViews: "Gesamtansichten",
    dashboardNoVideos: "Noch keine Videos erstellt",
    ...
    // Dashboard Page - Missing translations
    dashboardTotalVideos: "Videos gesamt",
    dashboardThisMonth: "diesen Monat",
    dashboardCurrentPlan: "Aktueller Plan",
    dashboardFreePlan: "Kostenloser Plan",
    dashboardUpgradeToPro: "Auf Pro upgraden",
    dashboardStorageUsed: "Speicher verwendet",
    ...
    settingsManageAccountPreferences: "Verwalten Sie Ihre Kontoeinstellungen",
    ...
    // Videos Page
    videosTitle: "Meine Videos",
    videosSubtitle: "Verwalten Sie Ihre erstellten Videos",
    videosCreateNew: "Neues Video erstellen",
    videosSearch: "Videos durchsuchen",
    videosFilter: "Filter",
    videosAll: "Alle",
    videosProcessing: "Wird verarbeitet",
    videosReady: "Bereit",
    videosError: "Fehler",
    videosNoVideos: "Noch keine Videos erstellt",
    videosCreateFirst: "Erstes Video erstellen",
    videosTitle: "Titel",
    videosStatus: "Status",
    videosCreated: "Erstellt",
    videosDuration: "Dauer",
    videosSize: "Größe",
    videosViews: "Ansichten",
    videosActions: "Aktionen",
    videosView: "Ansehen",
    videosDownload: "Herunterladen",
    videosShare: "Teilen",
    videosDelete: "Löschen",
    videosEdit: "Bearbeiten",
    videosDuplicate: "Duplizieren",
    videosProcessingProgress: "Verarbeitung: {progress}%",
    videosProcessingETA: "Geschätzte Zeit: {eta}",
    
    // Studio Wizard
    wizardTitle: "Video-Erstellungsassistent",
    wizardSubtitle: "Erstellen Sie Ihr perfektes Video",
    wizardStep1: "Avatar auswählen",
    wizardStep2: "Sprache wählen",
    wizardStep3: "Hintergrund auswählen",
    wizardStep4: "Text eingeben",
    wizardStep5: "Vorschau",
    wizardNext: "Weiter",
    wizardPrevious: "Zurück",
    wizardFinish: "Fertig",
    wizardCancel: "Abbrechen",
    wizardAvatarTitle: "Wählen Sie Ihren Avatar",
    wizardAvatarSubtitle: "Wählen Sie den perfekten Avatar für Ihr Video",
    wizardLanguageTitle: "Sprache und Stimme",
    wizardLanguageSubtitle: "Wählen Sie die Sprache und Stimme für Ihr Video",
    wizardBackgroundTitle: "Hintergrund auswählen",
    wizardBackgroundSubtitle: "Wählen Sie den perfekten Hintergrund für Ihr Video",
    wizardTextTitle: "Text eingeben",
    wizardTextSubtitle: "Geben Sie den Text ein, der in Ihrem Video gesprochen werden soll",
    wizardPreviewTitle: "Vorschau",
    wizardPreviewSubtitle: "Überprüfen Sie Ihr Video, bevor Sie es erstellen",
    wizardGenerating: "Video wird generiert...",
    wizardGeneratingSubtitle: "Bitte warten Sie, während wir Ihr Video erstellen",
    wizardSuccess: "Video erfolgreich erstellt!",
    wizardSuccessSubtitle: "Ihr Video ist bereit zum Herunterladen",
    wizardError: "Fehler beim Erstellen des Videos",
    wizardErrorSubtitle: "Bitte versuchen Sie es erneut",
    ...
    errorUnauthorized: "Sie sind nicht berechtigt, diese Aktion auszuführen.",
    errorForbidden: "Zugriff verweigert.",
    errorNotFound: "Die angeforderte Ressource wurde nicht gefunden.",
    ...
    errorPassword: "Passwort muss mindestens 8 Zeichen lang sein.",
    errorPasswordMatch: "Passwörter stimmen nicht überein.",
    errorTerms: "Sie müssen den Nutzungsbedingungen zustimmen.",
    ...
    successUploaded: "Erfolgreich hochgeladen",
    successDownloaded: "Erfolgreich heruntergeladen",
    
    // Admin Panel
    adminTitle: "Admin-Panel",
    adminSubtitle: "Verwalten Sie Ihre Plattform",
    ...
    // Admin Users
    adminUsersTitle: "Benutzer verwalten",
    adminUsersSubtitle: "Verwalten Sie alle Benutzer auf der Plattform",
    adminUsersTotal: "Gesamtbenutzer",
    adminUsersActive: "Aktive Benutzer",
    adminUsersNew: "Neue Benutzer",
    adminUsersSearch: "Benutzer durchsuchen",
    adminUsersFilter: "Filter",
    adminUsersAll: "Alle",
    adminUsersActive: "Aktiv",
    adminUsersInactive: "Inaktiv",
    adminUsersBanned: "Gesperrt",
    adminUsersName: "Name",
    adminUsersEmail: "E-Mail",
    adminUsersStatus: "Status",
    adminUsersJoined: "Beigetreten",
    adminUsersLastActive: "Letzte Aktivität",
    adminUsersActions: "Aktionen",
    adminUsersView: "Ansehen",
    adminUsersEdit: "Bearbeiten",
    adminUsersDelete: "Löschen",
    adminUsersBan: "Sperren",
    adminUsersUnban: "Entsperren",
    adminUsersResetPassword: "Passwort zurücksetzen",
    adminUsersSendEmail: "E-Mail senden",
    adminUsersExport: "Exportieren",
    adminUsersImport: "Importieren",
    adminUsersBulkActions: "Massenaktionen",
    adminUsersSelectAll: "Alle auswählen",
    adminUsersDeselectAll: "Alle abwählen",
    adminUsersDeleteSelected: "Ausgewählte löschen",
    adminUsersBanSelected: "Ausgewählte sperren",
    adminUsersUnbanSelected: "Ausgewählte entsperren",
    
    // Admin Videos
    adminVideosTitle: "Videos verwalten",
    adminVideosSubtitle: "Verwalten Sie alle Videos auf der Plattform",
    adminVideosTotal: "Gesamtvideos",
    adminVideosProcessing: "Wird verarbeitet",
    adminVideosReady: "Bereit",
    adminVideosError: "Fehler",
    adminVideosSearch: "Videos durchsuchen",
    adminVideosFilter: "Filter",
    adminVideosAll: "Alle",
    adminVideosProcessing: "Wird verarbeitet",
    adminVideosReady: "Bereit",
    adminVideosError: "Fehler",
    adminVideosTitle: "Titel",
    adminVideosUser: "Benutzer",
    adminVideosStatus: "Status",
    adminVideosCreated: "Erstellt",
    adminVideosDuration: "Dauer",
    adminVideosSize: "Größe",
    adminVideosViews: "Ansichten",
    adminVideosActions: "Aktionen",
    adminVideosView: "Ansehen",
    adminVideosDownload: "Herunterladen",
    adminVideosDelete: "Löschen",
    adminVideosApprove: "Genehmigen",
    adminVideosReject: "Ablehnen",
    adminVideosFlag: "Melden",
    adminVideosUnflag: "Meldung zurückziehen",
    adminVideosBulkActions: "Massenaktionen",
    adminVideosSelectAll: "Alle auswählen",
    adminVideosDeselectAll: "Alle abwählen",
    adminVideosDeleteSelected: "Ausgewählte löschen",
    adminVideosApproveSelected: "Ausgewählte genehmigen",
    adminVideosRejectSelected: "Ausgewählte ablehnen",
    
    // Admin Payments
    adminPaymentsTitle: "Zahlungen verwalten",
    adminPaymentsSubtitle: "Verwalten Sie alle Zahlungen auf der Plattform",
    adminPaymentsTotal: "Gesamtzahlungen",
    adminPaymentsRevenue: "Umsatz",
    ...
    adminPaymentsSearch: "Zahlungen durchsuchen",
    adminPaymentsFilter: "Filter",
    adminPaymentsAll: "Alle",
    adminPaymentsPending: "Ausstehend",
    adminPaymentsCompleted: "Abgeschlossen",
    adminPaymentsFailed: "Fehlgeschlagen",
    adminPaymentsRefunded: "Erstattet",
    adminPaymentsId: "ID",
    adminPaymentsUser: "Benutzer",
    adminPaymentsAmount: "Betrag",
    adminPaymentsStatus: "Status",
    adminPaymentsMethod: "Methode",
    adminPaymentsDate: "Datum",
    adminPaymentsActions: "Aktionen",
    adminPaymentsView: "Ansehen",
    adminPaymentsRefund: "Erstatten",
    adminPaymentsCancel: "Stornieren",
    adminPaymentsExport: "Exportieren",
    adminPaymentsBulkActions: "Massenaktionen",
    adminPaymentsSelectAll: "Alle auswählen",
    adminPaymentsDeselectAll: "Alle abwählen",
    adminPaymentsRefundSelected: "Ausgewählte erstatten",
    adminPaymentsCancelSelected: "Ausgewählte stornieren",
    
    // Admin Settings
    adminSettingsTitle: "Einstellungen",
    adminSettingsSubtitle: "Verwalten Sie die Plattformeinstellungen",
    adminSettingsGeneral: "Allgemein",
    adminSettingsSite: "Website",
    adminSettingsEmail: "E-Mail",
    adminSettingsPayment: "Zahlung",
    adminSettingsStorage: "Speicher",
    adminSettingsSecurity: "Sicherheit",
    adminSettingsMaintenance: "Wartung",
    adminSettingsSiteName: "Website-Name",
    adminSettingsSiteDescription: "Website-Beschreibung",
    adminSettingsSiteUrl: "Website-URL",
    adminSettingsSiteLogo: "Website-Logo",
    adminSettingsSiteFavicon: "Website-Favicon",
    adminSettingsEmailFrom: "E-Mail von",
    adminSettingsEmailReplyTo: "E-Mail Antwort an",
    adminSettingsEmailSmtp: "SMTP-Einstellungen",
    adminSettingsPaymentStripe: "Stripe-Einstellungen",
    adminSettingsPaymentPaypal: "PayPal-Einstellungen",
    adminSettingsStorageProvider: "Speicher-Anbieter",
    adminSettingsStorageConfig: "Speicher-Konfiguration",
    adminSettingsSecurityTwoFactor: "Zwei-Faktor-Authentifizierung",
    adminSettingsSecurityPassword: "Passwort-Richtlinien",
    adminSettingsSecuritySession: "Sitzungs-Einstellungen",
    adminSettingsMaintenanceMode: "Wartungsmodus",
    adminSettingsMaintenanceMessage: "Wartungsnachricht",
    adminSettingsSave: "Speichern",
    adminSettingsCancel: "Abbrechen",
    adminSettingsSaved: "Einstellungen erfolgreich gespeichert",
    adminSettingsError: "Fehler beim Speichern der Einstellungen",
    
    // Admin Analytics
    adminAnalyticsTitle: "Analytics",
    adminAnalyticsSubtitle: "Überwachen Sie die Plattform-Performance",
    adminAnalyticsOverview: "Überblick",
    adminAnalyticsUsers: "Benutzer",
    adminAnalyticsVideos: "Videos",
    adminAnalyticsPayments: "Zahlungen",
    adminAnalyticsRevenue: "Umsatz",
    adminAnalyticsViews: "Ansichten",
    adminAnalyticsEngagement: "Engagement",
    adminAnalyticsRetention: "Retention",
    adminAnalyticsConversion: "Konversion",
    adminAnalyticsTimeframe: "Zeitraum",
    adminAnalyticsLast7Days: "Letzte 7 Tage",
    adminAnalyticsLast30Days: "Letzte 30 Tage",
    adminAnalyticsLast90Days: "Letzte 90 Tage",
    adminAnalyticsLastYear: "Letztes Jahr",
    adminAnalyticsCustom: "Benutzerdefiniert",
    adminAnalyticsExport: "Exportieren",
    adminAnalyticsRefresh: "Aktualisieren",
    
    // Admin Reports
    adminReportsTitle: "Berichte",
    adminReportsSubtitle: "Generieren Sie detaillierte Berichte",
    adminReportsUsers: "Benutzer-Bericht",
    adminReportsVideos: "Video-Bericht",
    adminReportsPayments: "Zahlungs-Bericht",
    adminReportsRevenue: "Umsatz-Bericht",
    adminReportsCustom: "Benutzerdefinierter Bericht",
    adminReportsGenerate: "Generieren",
    adminReportsDownload: "Herunterladen",
    adminReportsEmail: "E-Mail senden",
    adminReportsSchedule: "Planen",
    adminReportsFormat: "Format",
    adminReportsPdf: "PDF",
    adminReportsExcel: "Excel",
    adminReportsCsv: "CSV",
    adminReportsDateRange: "Datumsbereich",
    adminReportsStartDate: "Startdatum",
    adminReportsEndDate: "Enddatum",
    adminReportsFilters: "Filter",
    adminReportsInclude: "Einschließen",
    adminReportsExclude: "Ausschließen",
    
    // Admin System
    adminSystemTitle: "System",
    adminSystemSubtitle: "Überwachen Sie das System",
    adminSystemStatus: "Status",
    adminSystemHealth: "Gesundheit",
    adminSystemUptime: "Betriebszeit",
    adminSystemLoad: "Last",
    adminSystemMemory: "Speicher",
    adminSystemDisk: "Festplatte",
    adminSystemNetwork: "Netzwerk",
    adminSystemDatabase: "Datenbank",
    adminSystemCache: "Cache",
    adminSystemQueue: "Warteschlange",
    adminSystemLogs: "Protokolle",
    adminSystemErrors: "Fehler",
    adminSystemWarnings: "Warnungen",
    adminSystemInfo: "Informationen",
    adminSystemDebug: "Debug",
    adminSystemRefresh: "Aktualisieren",
    adminSystemRestart: "Neustart",
    adminSystemShutdown: "Herunterfahren",
    
    // Admin Logs
    adminLogsTitle: "Protokolle",
    adminLogsSubtitle: "Überwachen Sie die Systemprotokolle",
    adminLogsLevel: "Level",
    adminLogsAll: "Alle",
    adminLogsError: "Fehler",
    adminLogsWarning: "Warnung",
    adminLogsInfo: "Information",
    adminLogsDebug: "Debug",
    adminLogsTime: "Zeit",
    adminLogsMessage: "Nachricht",
    adminLogsSource: "Quelle",
    adminLogsUser: "Benutzer",
    adminLogsIp: "IP",
    adminLogsUserAgent: "User Agent",
    adminLogsSearch: "Suchen",
    adminLogsFilter: "Filter",
    adminLogsExport: "Exportieren",
    adminLogsClear: "Löschen",
    adminLogsRefresh: "Aktualisieren",
    
    // Admin Backup
    adminBackupTitle: "Backup",
    adminBackupSubtitle: "Verwalten Sie System-Backups",
    adminBackupCreate: "Backup erstellen",
    adminBackupRestore: "Wiederherstellen",
    adminBackupDownload: "Herunterladen",
    adminBackupDelete: "Löschen",
    adminBackupSchedule: "Planen",
    adminBackupName: "Name",
    adminBackupSize: "Größe",
    adminBackupCreated: "Erstellt",
    adminBackupStatus: "Status",
    adminBackupActions: "Aktionen",
    adminBackupView: "Ansehen",
    adminBackupRestore: "Wiederherstellen",
    adminBackupDownload: "Herunterladen",
    adminBackupDelete: "Löschen",
    adminBackupScheduled: "Geplant",
    adminBackupRunning: "Läuft",
    adminBackupCompleted: "Abgeschlossen",
    adminBackupFailed: "Fehlgeschlagen",
    adminBackupDaily: "Täglich",
    adminBackupWeekly: "Wöchentlich",
    adminBackupMonthly: "Monatlich",
    adminBackupCustom: "Benutzerdefiniert",
    
    // Admin Maintenance
    adminMaintenanceTitle: "Wartung",
    adminMaintenanceSubtitle: "Führen Sie Wartungsaufgaben durch",
    adminMaintenanceMode: "Wartungsmodus",
    adminMaintenanceEnable: "Aktivieren",
    adminMaintenanceDisable: "Deaktivieren",
    adminMaintenanceMessage: "Wartungsnachricht",
    adminMaintenanceClearCache: "Cache löschen",
    adminMaintenanceOptimizeDatabase: "Datenbank optimieren",
    adminMaintenanceCleanLogs: "Protokolle bereinigen",
    adminMaintenanceUpdateSystem: "System aktualisieren",
    adminMaintenanceRestartServices: "Dienste neu starten",
    adminMaintenanceBackupDatabase: "Datenbank sichern",
    adminMaintenanceCheckUpdates: "Updates prüfen",
    adminMaintenanceInstallUpdates: "Updates installieren",
    adminMaintenanceReboot: "Neustart",
    adminMaintenanceShutdown: "Herunterfahren",
    adminMaintenanceStatus: "Status",
    adminMaintenanceRunning: "Läuft",
    adminMaintenanceCompleted: "Abgeschlossen",
    adminMaintenanceFailed: "Fehlgeschlagen",
    adminMaintenanceScheduled: "Geplant",
  ...
  fr: {
    ...
    studioSelectVirtualPresenter: "Sélectionnez un présentateur virtuel",
    studioEachAvatarUnique: "Chaque avatar est unique",
    studioShort: "Court",
    studioMedium: "Moyen",
    studioLong: "Long",
    ...
    onboardingStep1Title: "Créer un compte",
    onboardingStep1Desc: "Créez votre compte et choisissez votre plan",
    onboardingStep2Title: "Choisir un avatar",
    onboardingStep2Desc: "Sélectionnez votre avatar IA parfait",
    onboardingStep3Title: "Créer votre première vidéo",
    onboardingStep3Desc: "Créez votre première vidéo professionnelle",
    onboardingLetsGo: "Allons-y",
    ...
    pricingBasicTitle: "Basique",
    pricingBasicPrice: "29€",
    pricingBasicPeriod: "/mois",
    pricingBasicDescription: "Parfait pour les petites entreprises",
    pricingBasicFeatures: [
      "5 vidéos par mois",
      "Qualité HD",
      "Avatars de base",
    ...
    pricingCancelAnytime: "Annulable à tout moment",
    ...
    aboutSubtitle: "Nous révolutionnons la façon dont les entreprises créent des vidéos",
    aboutMission: "Notre mission",
    aboutMissionText: "Nous permettons à chaque entreprise de créer des vidéos professionnelles sans équipement coûteux ou expertise technique.",
    aboutVision: "Notre vision",
    aboutVisionText: "Un monde où chaque entreprise peut utiliser la puissance de la vidéo pour communiquer avec ses clients.",
    aboutValues: "Nos valeurs",
    aboutValue1Title: "Simplicité",
    aboutValue1Text: "Nous croyons que la technologie devrait être facile à utiliser.",
    aboutValue2Title: "Qualité",
    aboutValue2Text: "Nous ne livrons que la meilleure qualité à nos clients.",
    aboutValue3Title: "Innovation",
    aboutValue3Text: "Nous cherchons toujours de nouvelles façons d'aider.",
    aboutTeam: "Notre équipe",
    aboutTeamText: "Nous sommes une équipe passionnée de développeurs, designers et entrepreneurs.",
    aboutJoinUs: "Rejoignez notre équipe",
    aboutJoinUsText: "Nous cherchons toujours des personnes talentueuses pour nous aider à accomplir notre mission.",
    aboutJoinUsButton: "Postuler maintenant",
    ...
    dashboardVideosThisMonth: "Vidéos ce mois-ci",
    ...
    dashboardManageSubscription: "Gérer votre abonnement",
    ...
    // Dashboard Page - Missing translations
    dashboardTotalVideos: "Vidéos totales",
    dashboardThisMonth: "ce mois-ci",
    dashboardCurrentPlan: "Plan actuel",
    dashboardFreePlan: "Plan gratuit",
    dashboardUpgradeToPro: "Passer à Pro",
    dashboardStorageUsed: "Stockage utilisé",
    ...
    adminVideosCreated: "Vidéos créées",
