...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0b]">
      {/* Hero Section */}
      <section className="min-h-[60vh] flex items-center relative overflow-hidden w-full">
        {/* Background image */}
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10 max-w-7xl mx-auto py-20">
          <div className="max-w-3xl space-y-6">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight text-white">
              We&apos;d love to <span className="text-gradient bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">{translations.contactHearFromYou}</span>
            </h1>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 xl:px-12 relative overflow-hidden">
        {/* Background */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
                    ...
                    <form className="space-y-6" onSubmit={submit} noValidate>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 pt-2">
                        <button 
                          type="submit" 
                          disabled={loading}
                          className="group relative flex-1 inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-indigo-500/30 hover:scale-[1.02] transition-all duration-300 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                        >
            ...
            <div className="space-y-6">
              ...
              <div className="group relative p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl overflow-hidden hover:border-indigo-500/50 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300">
                ...
                <div className="relative z-10">
                  ...
                  <a 
                    ...
                    className="group/btn relative inline-flex items-center justify-center gap-3 w-full px-6 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-indigo-500/30 hover:scale-[1.02] transition-all duration-300 overflow-hidden"
                  >
                    <span className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-500 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
                  </a>
              ...
              <div className="group relative p-8 bg-gradient-to-br from-slate-800/30 to-slate-900/30 backdrop-blur-sm border border-slate-700/30 rounded-2xl overflow-hidden opacity-60">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-500/10 to-transparent rounded-bl-2xl" />
                <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-green-600/10 to-transparent rounded-tr-2xl" />
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 mb-3">{translations.contactComingSoon}</p>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-yellow-500 rounded-full animate-pulse"></div>
                        <span className="text-xs text-yellow-500 font-medium">{translations.contactInDevelopment}</span>
                      </div>
                    </div>
                  </div>
                  <p className="text-white/70 mb-6 leading-relaxed">
                  ...
                  <div className="w-full px-6 py-4 bg-white/5 border border-white/10 text-white/50 font-semibold rounded-xl cursor-not-allowed text-center">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 xl:px-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {/* FAQ Items */}
            <div className="group relative p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl overflow-hidden hover:border-indigo-500/50 hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="group relative p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl overflow-hidden hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="group relative p-8 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl overflow-hidden hover:border-pink-500/50 hover:shadow-2xl hover:shadow-pink-500/10 hover:-translate-y-1 transition-all duration-300">
