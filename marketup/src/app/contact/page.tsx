              ...
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
                ...
                <div className="space-y-8">
                    ...
                    {status === "success" ? (
                      <div className="glass-elevated rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                          ...
                          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground mb-3 sm:mb-4">Thanks! Your message has been sent.</h2>
                          <p className="text-base sm:text-lg lg:text-xl text-foreground-muted mb-6 sm:mb-8">We usually respond within 24 hours.</p>
                          <button 
                        ...
                        <div className="relative z-10">
                          <form className="space-y-4 sm:space-y-6" onSubmit={submit} noValidate>
                            <div className="space-y-3 sm:space-y-4">
                              <label className="text-sm sm:text-base font-medium text-foreground">Name</label>
                              <input 
                                id="name" 
                            ...
                            <div className="space-y-3 sm:space-y-4">
                              <label className="text-sm sm:text-base font-medium text-foreground">Message</label>
                              <textarea 
                                id="message" 
                                rows={4} 
                              ...
                              />
                              <p className="text-xs sm:text-sm text-foreground-muted">No bots, no spam. We&apos;ll only use your email to reply.</p>
                            </div>
                  ...
                  <div className="glass-elevated rounded-2xl sm:rounded-3xl p-6 sm:p-8 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground mb-4 sm:mb-6">Other ways to reach us</h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div className="flex items-center gap-3 sm:gap-4">
                          ...
                          <div>
                            <p className="font-semibold text-foreground text-sm sm:text-base">Business Hours</p>
                            <p className="text-xs sm:text-sm text-foreground-muted">Mon-Fri, 9AM-6PM EST</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                          ...
                          <div>
                            <p className="font-semibold text-foreground text-sm sm:text-base">Response Time</p>
                            <p className="text-xs sm:text-sm text-foreground-muted">Within 24 hours</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative z-10">
                      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-8 mb-6 sm:mb-10">
                        ...
                        <div className="text-center sm:text-left">
                          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-2">Email Support</h3>
                          <p className="text-base sm:text-lg lg:text-xl text-foreground-muted">Get help via email</p>
                          <div className="flex items-center justify-center sm:justify-start gap-2 mt-2">
                            <div className="w-2 h-2 bg-success rounded-full animate-pulse"></div>
                            <span className="text-xs sm:text-sm text-success font-medium">Online now</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        >
                          <span className="relative z-10 flex items-center justify-center gap-2 sm:gap-3">
                            ...
                            <span className="hidden sm:inline">support@marketup.app</span>
                  ...
                  <div className="group glass-elevated rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-2xl group-hover:shadow-green-500/20 group-hover:border-green-500/40 relative overflow-hidden opacity-60">
                    ...
                    <div className="relative z-10">
                      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-8 mb-6 sm:mb-10">
                        ...
                        <div className="text-center sm:text-left">
                          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-2">WhatsApp Support</h3>
                          <p className="text-base sm:text-lg lg:text-xl text-foreground-muted">Coming soon</p>
                          <div className="flex items-center justify-center sm:justify-start gap-2 mt-2">
                            <div className="w-2 h-2 bg-yellow-500 rounded-full animate-pulse"></div>
                            <span className="text-xs sm:text-sm text-yellow-500 font-medium">In development</span>
                          </div>
                        </div>
                      </div>
                      <p className="text-base sm:text-lg lg:text-xl text-foreground-muted mb-6 sm:mb-10 leading-relaxed">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="btn-outline w-full justify-center py-4 sm:py-5 text-sm sm:text-base lg:text-lg font-bold cursor-not-allowed">
                          <span className="flex items-center justify-center gap-2 sm:gap-3">
                            ...
                            <span className="hidden sm:inline">WhatsApp (Coming Soon)</span>
                ...
                <div className="group glass-elevated rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-2xl group-hover:shadow-accent/20 group-hover:border-accent/40 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      ...
                      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">How long does it take?</h3>
                    </div>
                ...
                <div className="group glass-elevated rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-2xl group-hover:shadow-accent-2/20 group-hover:border-accent-2/40 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      ...
                      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">Video quality?</h3>
                    </div>
                    <p className="text-sm sm:text-base lg:text-lg text-foreground-muted leading-relaxed">
                ...
                <div className="group glass-elevated rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-2xl group-hover:shadow-purple-500/20 group-hover:border-purple-500/40 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      ...
                      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">Custom voice?</h3>
                    </div>
                    <p className="text-sm sm:text-base lg:text-lg text-foreground-muted leading-relaxed">
                ...
                <div className="group glass-elevated rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-2xl group-hover:shadow-accent/20 group-hover:border-accent/40 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      ...
                      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">Commercial use?</h3>
                    </div>
                    <p className="text-sm sm:text-base lg:text-lg text-foreground-muted leading-relaxed">
