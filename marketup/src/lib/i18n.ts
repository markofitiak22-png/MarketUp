...
export const translations: Record<Language, Translations> = {
  ...
  de: {
    ...
    subscriptionInvoice: "Rechnung",
    subscriptionDate: "Datum",
    subscriptionAmount: "Betrag",
    subscriptionDownload: "Herunterladen",
    subscriptionNoInvoices: "Keine Rechnungen gefunden",
    ...
    billingSubtitle: "Verwalten Sie Ihre Zahlungsmethoden",
    billingPaymentMethod: "Zahlungsmethode",
    billingCardNumber: "Kartennummer",
    billingExpiryDate: "Ablaufdatum",
    billingCvv: "CVV",
    billingBillingAddress: "Rechnungsadresse",
    billingStreet: "Straße",
    billingCity: "Stadt",
    billingState: "Bundesland",
    billingZipCode: "Postleitzahl",
    billingCountry: "Land",
    billingSave: "Speichern",
    billingCancel: "Abbrechen",
    billingSaved: "Zahlungsmethode erfolgreich gespeichert",
    billingError: "Fehler beim Speichern der Zahlungsmethode",
    billingAddCard: "Karte hinzufügen",
    billingEditCard: "Karte bearbeiten",
    billingDeleteCard: "Karte löschen",
    billingDefaultCard: "Standardkarte",
    billingNoCards: "Keine Karten gefunden",
  ...
  fr: {
    ...
    authSignUpSubtitle: "Créez votre compte pour commencer",
    authConfirmPassword: "Confirmer le mot de passe",
    authAgreeTerms: "J'accepte les conditions d'utilisation",
    authAlreadyHaveAccount: "Déjà un compte ?",
    authSignInInstead: "Se connecter à la place",
    ...
    subscriptionInvoice: "Facture",
    subscriptionDate: "Date",
    subscriptionAmount: "Montant",
    subscriptionDownload: "Télécharger",
    subscriptionNoInvoices: "Aucune facture trouvée",
    ...
    billingSubtitle: "Gérez vos méthodes de paiement",
    billingPaymentMethod: "Méthode de paiement",
    billingCardNumber: "Numéro de carte",
    billingExpiryDate: "Date d'expiration",
    billingCvv: "CVV",
    billingBillingAddress: "Adresse de facturation",
    billingStreet: "Rue",
    billingCity: "Ville",
    billingState: "État",
    billingZipCode: "Code postal",
    billingCountry: "Pays",
    billingSave: "Enregistrer",
    billingCancel: "Annuler",
    billingSaved: "Méthode de paiement enregistrée avec succès",
    billingError: "Erreur lors de l'enregistrement de la méthode de paiement",
    billingAddCard: "Ajouter une carte",
    billingEditCard: "Modifier la carte",
    billingDeleteCard: "Supprimer la carte",
    billingDefaultCard: "Carte par défaut",
    billingNoCards: "Aucune carte trouvée",
    ...
    videosSubtitle: "Gérez vos vidéos créées",
    videosCreateNew: "Créer une nouvelle vidéo",
    videosSearch: "Rechercher des vidéos",
    videosFilter: "Filtrer",
    videosReady: "Prêtes",
    videosError: "Erreur",
    videosNoVideos: "Aucune vidéo créée",
    videosCreateFirst: "Créer la première vidéo",
    videosCreated: "Créé",
    videosSize: "Taille",
    videosActions: "Actions",
    videosProcessingProgress: "Traitement : {progress}%",
    videosProcessingETA: "Temps estimé : {eta}",
    
    // Studio Wizard
    wizardTitle: "Assistant de création vidéo",
    wizardSubtitle: "Créez votre vidéo parfaite",
    wizardStep1: "Choisir un avatar",
    wizardStep2: "Choisir la langue",
    wizardStep3: "Choisir l'arrière-plan",
    wizardStep4: "Saisir le texte",
    wizardStep5: "Aperçu",
    wizardNext: "Suivant",
    wizardPrevious: "Précédent",
    wizardFinish: "Terminer",
    wizardCancel: "Annuler",
    wizardAvatarTitle: "Choisissez votre avatar",
    wizardAvatarSubtitle: "Sélectionnez l'avatar parfait pour votre vidéo",
    wizardLanguageTitle: "Langue et voix",
    wizardLanguageSubtitle: "Choisissez la langue et la voix pour votre vidéo",
    wizardBackgroundTitle: "Choisir l'arrière-plan",
    wizardBackgroundSubtitle: "Sélectionnez l'arrière-plan parfait pour votre vidéo",
    wizardTextTitle: "Saisir le texte",
    wizardTextSubtitle: "Tapez le texte qui sera prononcé dans votre vidéo",
    wizardPreviewTitle: "Aperçu",
    wizardPreviewSubtitle: "Examinez votre vidéo avant de la créer",
    wizardGenerating: "Génération de la vidéo...",
    wizardGeneratingSubtitle: "Veuillez patienter pendant que nous créons votre vidéo",
    wizardSuccess: "Vidéo créée avec succès !",
    wizardSuccessSubtitle: "Votre vidéo est prête à être téléchargée",
    wizardError: "Erreur lors de la création de la vidéo",
    wizardErrorSubtitle: "Veuillez réessayer",
    ...
    errorNotFound: "La ressource demandée n'a pas été trouvée.",
    errorServer: "Erreur serveur. Veuillez réessayer plus tard.",
    errorValidation: "Veuillez vérifier vos entrées.",
    ...
    successUploaded: "Téléchargé avec succès",
    successDownloaded: "Téléchargé avec succès",
    
    // Admin Panel
    adminTitle: "Panneau d'administration",
    adminSubtitle: "Gérez votre plateforme",
    ...
    adminSystem: "Système",
    adminLogs: "Journaux",
    adminBackup: "Sauvegarde",
    adminMaintenance: "Maintenance",
    
    // Admin Users
    adminUsersTitle: "Gérer les utilisateurs",
    adminUsersSubtitle: "Gérez tous les utilisateurs de la plateforme",
    adminUsersTotal: "Utilisateurs totaux",
    adminUsersActive: "Utilisateurs actifs",
    adminUsersNew: "Nouveaux utilisateurs",
    adminUsersSearch: "Rechercher des utilisateurs",
    adminUsersFilter: "Filtrer",
    adminUsersAll: "Tous",
    adminUsersInactive: "Inactifs",
    adminUsersBanned: "Bannis",
    adminUsersName: "Nom",
    adminUsersEmail: "E-mail",
    adminUsersStatus: "Statut",
    adminUsersJoined: "Rejoint",
    adminUsersLastActive: "Dernière activité",
    adminUsersActions: "Actions",
    adminUsersView: "Voir",
    adminUsersEdit: "Modifier",
    adminUsersDelete: "Supprimer",
    adminUsersBan: "Bannir",
    adminUsersUnban: "Débannir",
    adminUsersResetPassword: "Réinitialiser le mot de passe",
    adminUsersSendEmail: "Envoyer un e-mail",
    adminUsersExport: "Exporter",
    adminUsersImport: "Importer",
    adminUsersBulkActions: "Actions en lot",
    adminUsersSelectAll: "Tout sélectionner",
    adminUsersDeselectAll: "Tout désélectionner",
    adminUsersDeleteSelected: "Supprimer la sélection",
    adminUsersBanSelected: "Bannir la sélection",
    adminUsersUnbanSelected: "Débannir la sélection",
    
    // Admin Videos
    adminVideosTitle: "Gérer les vidéos",
    adminVideosSubtitle: "Gérez toutes les vidéos de la plateforme",
    adminVideosTotal: "Vidéos totales",
    adminVideosProcessing: "En cours de traitement",
    adminVideosReady: "Prêtes",
    adminVideosError: "Erreur",
    adminVideosSearch: "Rechercher des vidéos",
    adminVideosFilter: "Filtrer",
    adminVideosAll: "Toutes",
    adminVideosUser: "Utilisateur",
    adminVideosStatus: "Statut",
    adminVideosCreated: "Créé",
    adminVideosDuration: "Durée",
    adminVideosSize: "Taille",
    adminVideosViews: "Vues",
    adminVideosActions: "Actions",
    adminVideosView: "Voir",
    adminVideosDownload: "Télécharger",
    adminVideosDelete: "Supprimer",
    adminVideosApprove: "Approuver",
    adminVideosReject: "Rejeter",
    adminVideosFlag: "Signaler",
    adminVideosUnflag: "Retirer le signalement",
    adminVideosBulkActions: "Actions en lot",
    adminVideosSelectAll: "Tout sélectionner",
    adminVideosDeselectAll: "Tout désélectionner",
    adminVideosDeleteSelected: "Supprimer la sélection",
    adminVideosApproveSelected: "Approuver la sélection",
    adminVideosRejectSelected: "Rejeter la sélection",
    
    // Admin Payments
    adminPaymentsTitle: "Gérer les paiements",
    adminPaymentsSubtitle: "Gérez tous les paiements de la plateforme",
    adminPaymentsTotal: "Paiements totaux",
    adminPaymentsRevenue: "Revenus",
    adminPaymentsPending: "En attente",
    adminPaymentsCompleted: "Terminés",
    adminPaymentsFailed: "Échoués",
    adminPaymentsRefunded: "Remboursés",
    adminPaymentsSearch: "Rechercher des paiements",
    adminPaymentsFilter: "Filtrer",
    adminPaymentsAll: "Tous",
    adminPaymentsId: "ID",
    adminPaymentsUser: "Utilisateur",
    adminPaymentsAmount: "Montant",
    adminPaymentsStatus: "Statut",
    adminPaymentsMethod: "Méthode",
    adminPaymentsDate: "Date",
    adminPaymentsActions: "Actions",
    adminPaymentsView: "Voir",
    adminPaymentsRefund: "Rembourser",
    adminPaymentsCancel: "Annuler",
    adminPaymentsExport: "Exporter",
    adminPaymentsBulkActions: "Actions en lot",
    adminPaymentsSelectAll: "Tout sélectionner",
    adminPaymentsDeselectAll: "Tout désélectionner",
    adminPaymentsRefundSelected: "Rembourser la sélection",
    adminPaymentsCancelSelected: "Annuler la sélection",
    
    // Admin Settings
    adminSettingsTitle: "Paramètres",
    adminSettingsSubtitle: "Gérez les paramètres de la plateforme",
    adminSettingsGeneral: "Général",
    adminSettingsSite: "Site",
    adminSettingsEmail: "E-mail",
    adminSettingsPayment: "Paiement",
    adminSettingsStorage: "Stockage",
    adminSettingsSecurity: "Sécurité",
    adminSettingsMaintenance: "Maintenance",
    adminSettingsSiteName: "Nom du site",
    adminSettingsSiteDescription: "Description du site",
    adminSettingsSiteUrl: "URL du site",
    adminSettingsSiteLogo: "Logo du site",
    adminSettingsSiteFavicon: "Favicon du site",
    adminSettingsEmailFrom: "E-mail de",
    adminSettingsEmailReplyTo: "E-mail de réponse",
    adminSettingsEmailSmtp: "Paramètres SMTP",
    adminSettingsPaymentStripe: "Paramètres Stripe",
    adminSettingsPaymentPaypal: "Paramètres PayPal",
    adminSettingsStorageProvider: "Fournisseur de stockage",
    adminSettingsStorageConfig: "Configuration du stockage",
    adminSettingsSecurityTwoFactor: "Authentification à deux facteurs",
    adminSettingsSecurityPassword: "Politique de mot de passe",
    adminSettingsSecuritySession: "Paramètres de session",
    adminSettingsMaintenanceMode: "Mode maintenance",
    adminSettingsMaintenanceMessage: "Message de maintenance",
    adminSettingsSave: "Enregistrer",
    adminSettingsCancel: "Annuler",
    adminSettingsSaved: "Paramètres enregistrés avec succès",
    adminSettingsError: "Erreur lors de l'enregistrement des paramètres",
    
    // Admin Analytics
    adminAnalyticsTitle: "Analyses",
    adminAnalyticsSubtitle: "Surveillez les performances de la plateforme",
    adminAnalyticsOverview: "Aperçu",
    adminAnalyticsUsers: "Utilisateurs",
    adminAnalyticsVideos: "Vidéos",
    adminAnalyticsPayments: "Paiements",
    adminAnalyticsRevenue: "Revenus",
    adminAnalyticsViews: "Vues",
    adminAnalyticsEngagement: "Engagement",
    adminAnalyticsRetention: "Rétention",
    adminAnalyticsConversion: "Conversion",
    adminAnalyticsTimeframe: "Période",
    adminAnalyticsLast7Days: "7 derniers jours",
    adminAnalyticsLast30Days: "30 derniers jours",
    adminAnalyticsLast90Days: "90 derniers jours",
    adminAnalyticsLastYear: "Dernière année",
    adminAnalyticsCustom: "Personnalisé",
    adminAnalyticsExport: "Exporter",
    adminAnalyticsRefresh: "Actualiser",
    
    // Admin Reports
    adminReportsTitle: "Rapports",
    adminReportsSubtitle: "Générez des rapports détaillés",
    adminReportsUsers: "Rapport utilisateurs",
    adminReportsVideos: "Rapport vidéos",
    adminReportsPayments: "Rapport paiements",
    adminReportsRevenue: "Rapport revenus",
    adminReportsCustom: "Rapport personnalisé",
    adminReportsGenerate: "Générer",
    adminReportsDownload: "Télécharger",
    adminReportsEmail: "Envoyer par e-mail",
    adminReportsSchedule: "Planifier",
    adminReportsFormat: "Format",
    adminReportsPdf: "PDF",
    adminReportsExcel: "Excel",
    adminReportsCsv: "CSV",
    adminReportsDateRange: "Plage de dates",
    adminReportsStartDate: "Date de début",
    adminReportsEndDate: "Date de fin",
    adminReportsFilters: "Filtres",
    adminReportsInclude: "Inclure",
    adminReportsExclude: "Exclure",
    
    // Admin System
    adminSystemTitle: "Système",
    adminSystemSubtitle: "Surveillez le système",
    adminSystemStatus: "Statut",
    adminSystemHealth: "Santé",
    adminSystemUptime: "Temps de fonctionnement",
    adminSystemLoad: "Charge",
    adminSystemMemory: "Mémoire",
    adminSystemDisk: "Disque",
    adminSystemNetwork: "Réseau",
    adminSystemDatabase: "Base de données",
    adminSystemCache: "Cache",
    adminSystemQueue: "File d'attente",
    adminSystemLogs: "Journaux",
    adminSystemErrors: "Erreurs",
    adminSystemWarnings: "Avertissements",
    adminSystemInfo: "Informations",
    adminSystemDebug: "Debug",
    adminSystemRefresh: "Actualiser",
    adminSystemRestart: "Redémarrer",
    adminSystemShutdown: "Arrêter",
    
    // Admin Logs
    adminLogsTitle: "Journaux",
    adminLogsSubtitle: "Surveillez les journaux système",
    adminLogsLevel: "Niveau",
    adminLogsAll: "Tous",
    adminLogsError: "Erreur",
    adminLogsWarning: "Avertissement",
    adminLogsInfo: "Information",
    adminLogsDebug: "Debug",
    adminLogsTime: "Heure",
    adminLogsMessage: "Message",
    adminLogsSource: "Source",
    adminLogsUser: "Utilisateur",
    adminLogsIp: "IP",
    adminLogsUserAgent: "User Agent",
    adminLogsSearch: "Rechercher",
    adminLogsFilter: "Filtrer",
    adminLogsExport: "Exporter",
    adminLogsClear: "Effacer",
    adminLogsRefresh: "Actualiser",
    
    // Admin Backup
    adminBackupTitle: "Sauvegarde",
    adminBackupSubtitle: "Gérez les sauvegardes système",
    adminBackupCreate: "Créer une sauvegarde",
    adminBackupRestore: "Restaurer",
    adminBackupDownload: "Télécharger",
    adminBackupDelete: "Supprimer",
    adminBackupSchedule: "Planifier",
    adminBackupName: "Nom",
    adminBackupSize: "Taille",
    adminBackupCreated: "Créé",
    adminBackupStatus: "Statut",
    adminBackupActions: "Actions",
    adminBackupView: "Voir",
    adminBackupScheduled: "Planifié",
    adminBackupRunning: "En cours",
    adminBackupCompleted: "Terminé",
    adminBackupFailed: "Échoué",
    adminBackupDaily: "Quotidien",
    adminBackupWeekly: "Hebdomadaire",
    adminBackupMonthly: "Mensuel",
    adminBackupCustom: "Personnalisé",
    
    // Admin Maintenance
    adminMaintenanceTitle: "Maintenance",
    adminMaintenanceSubtitle: "Effectuez des tâches de maintenance",
    adminMaintenanceMode: "Mode maintenance",
    adminMaintenanceEnable: "Activer",
    adminMaintenanceDisable: "Désactiver",
    adminMaintenanceMessage: "Message de maintenance",
    adminMaintenanceClearCache: "Vider le cache",
    adminMaintenanceOptimizeDatabase: "Optimiser la base de données",
    adminMaintenanceCleanLogs: "Nettoyer les journaux",
    adminMaintenanceUpdateSystem: "Mettre à jour le système",
    adminMaintenanceRestartServices: "Redémarrer les services",
    adminMaintenanceBackupDatabase: "Sauvegarder la base de données",
    adminMaintenanceCheckUpdates: "Vérifier les mises à jour",
    adminMaintenanceInstallUpdates: "Installer les mises à jour",
    adminMaintenanceReboot: "Redémarrer",
    adminMaintenanceShutdown: "Arrêter",
    adminMaintenanceStatus: "Statut",
    adminMaintenanceRunning: "En cours",
    adminMaintenanceCompleted: "Terminé",
    adminMaintenanceFailed: "Échoué",
    adminMaintenanceScheduled: "Planifié",
